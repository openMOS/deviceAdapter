...
import org.fortiss.uaserver.device.lowlevel.subscriptions.SubscriptionJoin;
...
import org.fortiss.uaserver.device.lowlevel.subscriptions.SubscriptionPrint;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class PrintBottomCover extends LboroSkillMethod {
    
    private String colour;

    public PrintBottomCover(String stationName) {
            super();
        ...
        public void setMethod(MsbGenericComponent msbComponent, String deviceAdapterId, String recipeId,
            ...
            if (!inputArguments.isEmpty()) {
                ...
                this.colour = inputArguments.get("Color_Parameter/Program");
            }
        }
        ...
        public void invokeSkillLowLevelFunctions() throws ExecutionException, InterruptedException {
            ...
            Variant[] input = new Variant[3];

            input[0] = new Variant(Short.valueOf(programId));
            input[1] = new Variant(Short.valueOf(colour));
            input[2] = new Variant(Float.parseFloat(speed));
        ...
        public void setAddress(String stationName) {
            switch (stationName) {
            case "17":
                this.addr = SkillsBackends.PRINTING_SERVER_1.getAddr();
                break;
            case "18":
                this.addr = SkillsBackends.PRINTING_SERVER_2.getAddr();
                break;
            case "19":
                this.addr = SkillsBackends.PRINTING_SERVER_3.getAddr();
                break;
            default:
                this.addr = SkillsBackends.PRINTING_SERVER_1.getAddr();
            }
