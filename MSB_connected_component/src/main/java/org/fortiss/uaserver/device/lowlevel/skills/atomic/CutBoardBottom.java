...
public class CutBoardBottom extends LboroSkillMethod {

    public CutBoardBottom(String stationName) {
        super();
    ...
    public void setAddress(String stationName) {
        switch (stationName) {
        case "1":
            this.addr = SkillsBackends.LASER_SERVER_1.getAddr();
            break;
        case "2":
            this.addr = SkillsBackends.LASER_SERVER_2.getAddr();
            break;
        case "3":
            this.addr = SkillsBackends.LASER_SERVER_3.getAddr();
            break;
        case "4":
            this.addr = SkillsBackends.LASER_SERVER_4.getAddr();
            break;
        default:
            this.addr = SkillsBackends.LASER_SERVER_1.getAddr();
        }
