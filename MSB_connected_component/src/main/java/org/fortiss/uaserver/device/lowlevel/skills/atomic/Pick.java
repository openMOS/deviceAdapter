...
import org.fortiss.uaserver.device.lowlevel.subscriptions.SubscriptionPick;

public class Pick extends LboroSkillMethod{

    public Pick(String stationName) {
        super();
        skillSubscription = new SubscriptionPick(stationName);
